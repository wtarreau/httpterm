...
#define HTTPTERM_VERSION "1.7.8"
#endif

#ifndef HTTPTERM_DATE
#define HTTPTERM_DATE	"2019/09/08"
#endif
...
const char *HTTP_HELP =
	...
	"                     E.g. /?r=404\n"
	" - /?c=<cache>       set the return as not cacheable if zero.\n"
	"                     E.g. /?c=0\n"
	" - /?C=<close>       force the response to use close if not zero.\n"
	"                     E.g. /?C=1\n"
	" - /?K=<keep-alive>  force the response to use keep-alive if not zero.\n"
	"                     E.g. /?K=1\n"
